...
class Rossmann ( object ):
    def __init__( self ):
        self.home_path =  '/home/samuel-lima-ds/repos/data_science_producao/rossmann_sales/'
    ...
    def data_preparation(self, df5):
        ...
        cols_selected = [ 'store', 'promo', 'store_type', 'assortment','competition_distance', 
                        ...
                        'promo_time_week', 'day_of_week_sen', 'day_of_week_cos', 'month_sen', 
                        'month_cos', 'day_sen', 'day_cos', 'week_of_year_sen', 'week_of_year_cos']
